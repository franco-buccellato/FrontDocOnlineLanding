            ...
            <div className='content'>
                ...
                <div className='card' style={{flexDirection: 'row'}}>
                    ...
                    <div className='card-container-text'>
                        <div>
                            ...
                            <a href="https://drive.google.com/file/d/1OYs8sBzpi8uln-1kGxpTrOOcEPXWdkWG/view" target="_blank">
                ...
                <div className='card' style={{flexDirection: 'row-reverse'}}>
                    ...
                    <div className='card-container-text'>
                        ...
                        <a href="https://drive.google.com/file/d/1QTIPfboOJytPdNvqGpu4GfXalUr5RYhr/view" target="_blank">
