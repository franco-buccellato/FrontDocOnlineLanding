            ...
            <div className='content'>
                ...
                <nav ref={navRef}>
                    <ul>
                        ...
                        {
                            estaLogueado() ? <Link to={'/sesion'} target='__blank'><li onClick={showNavbar}>{usuario.nombre}</li></Link> : <Link to={'https://doconlineargentina.com/turnero/'}><li onClick={showNavbar}>Ingresar</li></Link>
                        }
                    </ul>
                    <button
